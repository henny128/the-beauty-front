    ...
    return (
        <>
            <section className='flex flex-col w-full md:hidden' about='mobile view'>
                <LazyImage src='girl.png' classesContainer='h-[380px]' playAnimatiom={true} />
                ...
                <FadeUp className='py-6 px-5 flex flex-col gap-3 text-left word-space'>
                    <>
                        ...
                        <LazyImage src='/girl.png' classesContainer='h-[200px] mt-2' playAnimatiom={true} />
                    </>
                </FadeUp>
            </section>
            <section about='desktop view' className='hidden md:flex w-full justify-between mt-9 xl:mt-5'>
                <div className="relative top-0 h-[550px] lg:h-full w-1/2 bg-[url(girl.png)] bg-[size:400px_100dvh] lg:bg-[size:700px_100dvh] bg-[position:right_center] bg-no-repeat bg-fixed">
                </div>

                <FadeUp className='ps-5 flex flex-col gap-3 w-1/4'>
                    <>
                        <LazyImage src='pink.png' classesContainer='h-[200px] lg:h-[400px]' playAnimatiom={true} />
